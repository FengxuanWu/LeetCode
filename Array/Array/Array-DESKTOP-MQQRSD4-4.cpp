	...
	{	
		if (arr[max_idx] > arr[i])
		{
			...
			if (arr[i] > arr[i - 1])
			{
				...
				current_tree += (arr[i] - arr[i - 1]) * arr[j];
			}
		}
		else
		{
...
//			max_idx = i;
//			second_max_idx = -1;
//			//sub_trees.push_back(current_tree);
//		}
//		else
//		{
//			if (second_max_idx == -1 || arr[i] > arr[second_max_idx])
//			{
//				current_tree += (arr[i] - arr[second_max_idx]) * arr[max_idx] + arr[i] * arr[second_max_idx];
//				second_max_idx = i;
//			}
//			else
//			{
//				current_tree += arr[i] * (arr[max_idx] - arr[second_max_idx]);
//			}
//		}
//#if(DEBUG)
//		cout << "max: " << arr[max_idx] << endl;
//		cout << "second max: " << arr[second_max_idx] << endl;
//		cout << current_tree << endl;
//#endif
//	}